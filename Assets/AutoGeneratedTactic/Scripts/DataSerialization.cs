...
namespace DataSerializationDefinition
{
	public class DataSerialization : MonoBehaviour
	{
		...
		private void Awake()
		{
			path = Application.dataPath + @"/AutoGeneratedTactic/Data/Output/";
		}

		public IEnumerator OutputAutoTacticData(int tacticLength, int tacticWidth, Chromosome outputChromosome, string gameObjectID, bool isBait, bool isAmbush, bool isPronged, bool isDefense, bool isClash)
		{
			...
			var fileName = path + "AutoTactic_" + nameTactic + gameObjectID + ".xml";
			xdoc.Save(fileName);
