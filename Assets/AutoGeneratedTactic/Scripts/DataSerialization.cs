...
namespace DataSerializationDefinition
{
	public class DataSerialization : MonoBehaviour
	{
		...
		public IEnumerator OutputAutoTacticData(int tacticLength, int tacticWidth, Chromosome outputChromosome, string gameObjectID)
		{
			...
			var fileName = path + "AutoTactic_"+ gameObjectID + ".xml";
			xdoc.Save(fileName);
