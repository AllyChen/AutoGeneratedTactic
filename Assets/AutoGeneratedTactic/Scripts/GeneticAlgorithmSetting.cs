...
namespace GeneticAlgorithmSettingDefinition
{
	...
	public class GeneticAlgorithmSetting : MonoBehaviour
	{
		...
		public void Selection()
		{
			...
			for (int i = 0; i < _numChromosomes; i++)
			{
				sum_fitnessScore += _population[i].FitnessScore[FitnessFunctionName.ImpassableDensity];
			}
			...
			for (int i = 0; i < _numChromosomes; i++)
			{
				...
				{
					probabilityChoose += _population[i].FitnessScore[FitnessFunctionName.ImpassableDensity] / sum_fitnessScore;
					rouletteWheel.Add(probabilityChoose);
				}				
			}
		...
		public Chromosome BestChromesome()//Chromosome bestChromesome)
		{
			...
			for (int i = 0; i < _numChromosomes; i++)
			{
				if (_population[index_BestChromesome].FitnessScore[FitnessFunctionName.ImpassableDensity] < _population[i].FitnessScore[FitnessFunctionName.ImpassableDensity])
				{
